import { ScatterChart as ReScatterChart, Scatter, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer } from 'recharts'
  ...
  return (
    <ResponsiveContainer width="100%" height={420}>
      <ReScatterChart margin={{ top: 20, right: 30, left: 10, bottom: 30 }}>
        ...
        <XAxis type="number" dataKey="x" name={spec.x} {...axisStyle} label={{ value: spec.x_label, position: 'insideBottom', offset: -15, fill: t.axisColor, fontSize: 12 }} />
